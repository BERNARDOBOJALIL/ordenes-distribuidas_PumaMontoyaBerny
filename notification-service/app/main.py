...
def handle_order_created(body: bytes) -> None:
    ...
    logger.info("confirmación enviada customer=%s order_id=%s", customer, order_id)
...
def run_consumer() -> None:
    while True:
        ...
        try:
            ...
            channel.basic_consume(queue=settings.notification_queue, on_message_callback=on_message)
